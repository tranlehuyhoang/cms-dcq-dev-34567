...
@section('content')
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-4">
                    <a href="{{ route('user.add') }}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i>
                        Add New</a>
                </div>
                <div class="col-sm-8">
                    <div>
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="text-center card">
                        <div class="card-body">
                            ...
                            <?php
                                if (count($avatarUsers[$value['id']]) > 0) {
                            ...
                            <?php
                                    ...
                                    ?>
                            <img src="/assets/images/users/avatar-basic.jpg"
                                class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image">
                            <?php
                                }
                                ?>

                            <h4 class="mt-3 mb-1"><a href="{{ route('user.edit', $value['id']) }}"
                                    class="text-dark"><?php echo $value['name']; ?></a></h4>
                            <p class="text-muted">@Role <span> | </span> <span> <a
                                        href="{{ route('user.edit', $value['id']) }}"
                                        class="text-pink"><?php echo $value['user_role']['name']; ?></a> </span></p>

                            <ul class="social-list list-inline mt-4 mb-2">
                                <li class="list-inline-item">
                                    <a href="<?php echo $value['facebook']; ?>" class="social-list-item border-purple text-purple"
